  ...
  return (
    <>
      <section className="h-full w-full md:pt-44 mt-[70px] relative flex items-center justify-center flex-col">
        ...
        <p className="text-center font-semibold text-lg md:mt-[230px]">Run your agency, in one place</p>
        <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
          <h1 className="text-9xl font-bold text-center md:text-[250px]">Nebula</h1>
        </div>
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-[330px] mt-[-60px]">
        ...
        <div className="flex justify-center flex-wrap gap-4 mt-6">
          {pricingCards.map((card) => (
            <Card
              ...
              <CardFooter className="flex items-start gap-4 flex-col">
                <div>
                ...
                <Link
                  ...
                  className={cn(
                    "w-full p-2 rounded-md text-center bg-primary",
